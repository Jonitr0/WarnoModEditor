...
class OperationEditorPage(base_napo_page.BaseNapoPage):
    ...
    def __init__(self):
        ...
        self.enemy_scroll_layout = QtWidgets.QVBoxLayout()
        self.enemy_scroll_layout.setContentsMargins(0, 10, 0, 0)
        opfor_scroll_widget.setLayout(self.enemy_scroll_layout)
    ...
    def clear_layouts(self):
        ...
        while self.enemy_scroll_layout.count():
            child = self.enemy_scroll_layout.takeAt(0)
            if child.widget():
                child.widget().deleteLater()
